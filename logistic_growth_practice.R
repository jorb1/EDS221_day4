...
for (i in seq_along(time_vec)) {
  population <- logistic_growth(N0 = 100, K = 6000, r = 0.227, time = time_vec[i])
...
#making an output matrix (This is the final result!)
...
#this makes the data long instead of wide ( more on this next week)
out_df_long <- out_df |>
